...
const questoes: QuestaoModel[] = [
	...
	new QuestaoModel(217, 'Qual é o maior planeta do sistema solar?', [
	...
	new QuestaoModel(218, 'Quem escreveu a obra "O Pequeno Príncipe"?', [
		RespostaModel.errada('Machado de Assis'),
		RespostaModel.errada('Fernando Pessoa'),
		RespostaModel.errada('Jorge Amado'),
		RespostaModel.certa('Antoine de Saint-Exupéry'),
	]),
		
	new QuestaoModel(219, 'Em que continente está localizado o Deserto do Saara?', [
	...
	new QuestaoModel(220, 'Qual é o maior oceano da Terra?', [
